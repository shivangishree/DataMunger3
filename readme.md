...
1. Clone the base boilerplate in the folder **assignment-solution-step4** of your local machine
    ...
    `git clone https://gitlab.stackroute.in/Boeing-Immersive/wave1/DataMungerStep4_Boilerplate assignment-solution-step4`
...
5. Add your new repository reference as remote
     ...
     `git remote add origin https://gitlab.stackroute.in/{{yourusername}}/assignment-solution-step4.git`
